...
public class MakeOperationFrame extends JFrame {
	 ...
	 */
	public MakeOperationFrame(User currentUser) {
		if (currentUser != null) {
			...
			this.sqlInteraction=currentUser.getSQLInstance();
	...
	public MakeOperationFrame(User currentUser, BankAccount currentBankAccount) {
		if (currentUser != null) {
			this.firstName = currentUser.getFirstName();
			this.lastName = currentUser.getLastName();
			this.address = currentUser.getAddress();
